...
### Fill the database with **lopocs*builder**

For example with a e57 St Sulpice point cloud coming from [here](http://www.libe57.org/data.html):
...
```
(venv)$ lopocs_builder Trimble_StSulpice-Cloud-50mm.e57 outdir pc_stsulpice \
...
Then you can run LOPoCS with uWSGI:
